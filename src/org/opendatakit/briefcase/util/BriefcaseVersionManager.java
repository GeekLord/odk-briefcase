...
public class BriefcaseVersionManager {
  ...
  public String getLatest() {
    return http.execute(RequestBuilder.get("https://api.github.com/repos/GeekLord/odk-briefcase/releases/latest")
        .asJsonMap()
  ...
  public static URL getLatestUrl() {
    return url("https://github.com/GeekLord/odk-briefcase/releases/latest");
  }
}
