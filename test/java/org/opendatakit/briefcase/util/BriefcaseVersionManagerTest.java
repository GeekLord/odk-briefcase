...
public class BriefcaseVersionManagerTest {
  ...
  public void knows_the_url_to_get_the_latest_version() {
    assertThat(getLatestUrl(), is(url("https://github.com/GeekLord/odk-briefcase/releases/latest")));
  }
  ...
  public void knows_to_get_the_latest_available_version() {
    ...
    http.stub(
        get(url("https://api.github.com/repos/GeekLord/odk-briefcase/releases/latest")).build(),
